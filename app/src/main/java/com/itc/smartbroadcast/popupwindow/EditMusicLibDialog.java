...
public class EditMusicLibDialog extends Dialog implements View.OnClickListener {
    ...
    public EditMusicLibDialog(Context context) {
        this(context, 0, null);
    }

    public EditMusicLibDialog(Context context, int theme, View contentView) {
        ...
        if (mView == null) {
            mView = View.inflate(mContext, R.layout.dialog_edit_music, null);
        }
    ...
    private void initView() {
        ...
        mMsgEt.addTextChangedListener(new LimitInputTextWatcher(mMsgEt));
...
//					}
                        ...
                        ToastUtil.show(mContext,"请输入正确的文件夹名");
                    }
                }
                break;
        }
