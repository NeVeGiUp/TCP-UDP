...
public class ChooseAmplifierTerminalAdapter extends BaseAdapter {
    ...
    ChooseAmplifierTerminalActivity chooseAmplifierTerminalActivity;
    ...
    public ChooseAmplifierTerminalAdapter(List<FoundDeviceInfo> foundDeviceInfos, List<FoundDeviceInfo> deviceListed, Context mContext, ChooseAmplifierTerminalActivity chooseAmplifierTerminalActivity) {
        this.deviceList.clear();
        this.deviceListed.clear();
        this.deviceList.addAll(foundDeviceInfos);
        this.deviceListed.addAll(deviceListed);
        this.mContext = mContext;
        this.chooseAmplifierTerminalActivity = chooseAmplifierTerminalActivity;
        initCheck();
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        testViewHolder.item_checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                chooseAmplifierTerminalActivity.setCheckSize(checkBoxIDList.size());
            }
        });
            ...
            public void onClick(View view) {
                ...
                btnOk.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        chooseAmplifierTerminalActivity.setDeviceListed(device);
                        dialog.dismiss();
                    }
                });
