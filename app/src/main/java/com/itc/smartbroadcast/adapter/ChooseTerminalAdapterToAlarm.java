...
public class ChooseTerminalAdapterToAlarm extends BaseAdapter {
    ...
    ChoosePlayTerminalActivityToAlarm choosePlayTerminalActivityToAlarm;
    ...
    public ChooseTerminalAdapterToAlarm(List<FoundDeviceInfo> foundDeviceInfos, List<FoundDeviceInfo> deviceListed, Context mContext, ChoosePlayTerminalActivityToAlarm choosePlayTerminalActivityToAlarm) {
        this.deviceList.clear();
        this.deviceListed.clear();
        this.deviceList.addAll(foundDeviceInfos);
        this.deviceListed.addAll(deviceListed);
        this.mContext = mContext;
        this.choosePlayTerminalActivityToAlarm = choosePlayTerminalActivityToAlarm;
        initCheck();
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        testViewHolder.item_checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                choosePlayTerminalActivityToAlarm.setCheckSize(checkBoxIDList.size());
            }
        });
            ...
            public void onClick(View view) {
                ...
                btnOk.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        choosePlayTerminalActivityToAlarm.setDeviceListed(device);
                        dialog.dismiss();
                    }
                });
