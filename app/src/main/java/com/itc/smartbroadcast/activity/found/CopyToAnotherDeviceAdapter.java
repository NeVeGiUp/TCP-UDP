...
import com.itc.smartbroadcast.activity.found.CopyToAnotherDeviceActivity;
...
public class CopyToAnotherDeviceAdapter extends BaseAdapter {
    ...
    CopyToAnotherDeviceActivity copyToAnotherDeviceActivity;
    ...
    public CopyToAnotherDeviceAdapter(List<FoundDeviceInfo> foundDeviceInfos, List<FoundDeviceInfo> deviceListed, Context mContext, CopyToAnotherDeviceActivity copyToAnotherDeviceActivity) {
        this.deviceList.clear();
        this.deviceListed.clear();
        this.deviceList.addAll(foundDeviceInfos);
        this.deviceListed.addAll(deviceListed);
        this.mContext = mContext;
        this.copyToAnotherDeviceActivity = copyToAnotherDeviceActivity;
        initCheck();
    }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (true) {
            ...
            testViewHolder.item_button = (Button) convertView.findViewById(R.id.iv_dialog);
        ...
        testViewHolder.item_button.setVisibility(View.GONE);
        ...
        testViewHolder.item_checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                copyToAnotherDeviceActivity.setCheckSize(checkBoxIDList.size());
            }
        });
        return convertView;
    }
