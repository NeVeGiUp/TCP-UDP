 ...
 */
public class CreateInstantTaskActivity extends Base2Activity {
    ...
    public void complete() {
        ...
        EditInstantTask.sendCMD(AppDataCache.getInstance().getString("loginIp"), instantTask, instantTaskDetail, 0);
    }
