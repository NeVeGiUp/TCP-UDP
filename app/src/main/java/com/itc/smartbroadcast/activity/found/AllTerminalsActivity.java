 ...
 */
public class AllTerminalsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mContext = AllTerminalsActivity.this;
        ...
        StatusBarUtil.setColor(AllTerminalsActivity.this, getResources().getColor(R.color.colorMain), 0);
        ...
        if ("getDeviceList".equals(baseBean.getType())) {
            ...
            if (data != null) {
                ...
                for (FoundDeviceInfo foundDeviceInfo : infoList) {
                    ...
                    if (foundDeviceInfo.getDeviceMedel().contains("Z")){
                        foundDeviceInfo.setZhDeviceType("功放设备");
                    }
                }

                if (filterDeviceStatus.equals("全部")&&filterDeviceType.equals("全部")){
                    FdData.addAll(operableDeviceInfoList);
                    FdAdapter = new TerminalAdapter(AllTerminalsActivity.this, FdData);
                ...
                list_terminals.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        intent5.setClass(AllTerminalsActivity.this, DeviceDetailActivity.class);
...
//                        intent5.putExtra("FlierDeviceType",filterDeviceType);
//                        intent5.putExtra("FlierDeviceStauts",filterDeviceStatus);
                        AllTerminalsActivity.this.startActivityForResult(intent5, 5);
                    }
                });
        ...
        if ("editTerminalResult".equals(baseBean.getType())) {
            ...
            if (resultCode[6] == 1) {
                ToastUtil.show(AllTerminalsActivity.this, "删除成功");
                init();
            } else {
                ToastUtil.show(AllTerminalsActivity.this, "删除失败");
            }
        }
    ...
    private void deleteDevice(final int position) {
        ...
        vb.vibrate(100);
        CustomDialog dialog = new CustomDialog(AllTerminalsActivity.this, "提示", "确定要删除当前设备？",
...
//		mraRatingBar.setEnabled(false);
        ...
        switch (filterDeviceStatus){
            ...
            case "故障":
                ...
                break;
            case "空载":
                radioButton2 = (RadioButton)view.findViewById(R.id.rb_empty);
                radioButton2.setChecked(true);
        }
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mrg.check(2131559151);
                mrg2.check(2131559160);
            }
        });
