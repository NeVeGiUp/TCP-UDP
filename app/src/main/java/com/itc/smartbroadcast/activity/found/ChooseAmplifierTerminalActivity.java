...
//功放设备
public class ChooseAmplifierTerminalActivity extends Base2Activity {
    ...
    private ChooseAmplifierTerminalAdapter adapter;
...
//                }
                ...
                adapter = new ChooseAmplifierTerminalAdapter(adapterList, deviceList, ChooseAmplifierTerminalActivity.this, ChooseAmplifierTerminalActivity.this);
...
//                List<FoundDeviceInfo> checkTerminal = adapter.getCheckBoxIDList();
    ...
    private void resultPost(String result) {
        ...
        //设置返回数据
        ChooseAmplifierTerminalActivity.this.setResult(RESULT_OK, intent);
        //关闭Activity
        ChooseAmplifierTerminalActivity.this.finish();
    }
