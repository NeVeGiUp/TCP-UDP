...
//功放设备
public class ChoosePlayTerminalActivity extends Base2Activity {
    ...
    private ChooseTerminalAdapterToTask adapter;
    ...
    public void setDeviceListed(FoundDeviceInfo device) {
        for (int i = 0; i < deviceListed.size(); i++) {
            if (deviceListed.get(i).getDeviceMac().equals(device.getDeviceMac())) {
                deviceListed.set(i, device);
            }
        }
    }
    ...
    private void init() {
        ...
        String str = getIntent().getStringExtra("alarm");
        ...
        tvCheckSize.setText("已选择:" + deviceListed.size());
            ...
            if (data != null) {
                ...
                for (int i = 0; i < operableDeviceInfoList.size(); i++) {
                    if ((operableDeviceInfoList.get(i).getDeviceMedel().equals("TX-8660")
                            ...
                            || operableDeviceInfoList.get(i).getDeviceMedel().equals("TX-8606")) {
...
//                }
                ...
                adapter = new ChooseTerminalAdapterToTask(foundDeviceInfos1, deviceList, ChoosePlayTerminalActivity.this, ChoosePlayTerminalActivity.this);
...
//                List<FoundDeviceInfo> checkTerminal = adapter.getCheckBoxIDList();
    ...
    private void resultPost(String result) {
        ...
        //设置返回数据
        ChoosePlayTerminalActivity.this.setResult(RESULT_OK, intent);
        //关闭Activity
        ChoosePlayTerminalActivity.this.finish();
    }
