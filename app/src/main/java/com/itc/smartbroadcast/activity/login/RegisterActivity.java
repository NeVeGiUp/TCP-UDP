...
//        etPhoneNum.setText("17329918983");
//        etPass.setText("123456");
//        etRePass.setText("123456");
    }
        ...
        switch (baseBean.getType()) {
            ...
            case "cloudgetRegister":
                ...
                if ("success".equals(baseBean1.getType())) {
                    ...
                    if (cloudRegisterInfo.getMessage().equals("注册成功")){
                        finish();
                    }
                } else {
        ...
        switch (view.getId()) {
            ...
            case R.id.bt_get_sms_code:
                ...
                if (!b) {
                    ...
                    CloudProtocolModel.postCloudRegisterCode(phoneNum, RegisterActivity.this);
                }
                break;
            case R.id.bt_reg:
                ...
                if (password.length() != 6) {
                    ...
                    CloudProtocolModel.postCloudRegister(mapData, this);
                } else {
                    etPass.setText("");
                    etRePass.setText("");
