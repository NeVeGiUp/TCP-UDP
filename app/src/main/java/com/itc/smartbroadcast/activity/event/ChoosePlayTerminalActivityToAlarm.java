...
//                }
                ...
                adapter = new ChooseTerminalAdapterToAlarm(adapterList, deviceList, this, ChoosePlayTerminalActivityToAlarm.this);
...
//                List<FoundDeviceInfo> checkTerminal = adapter.getCheckBoxIDList();
    ...
    private void resultPost(String result) {
        ...
        //设置返回数据
        ChoosePlayTerminalActivityToAlarm.this.setResult(RESULT_OK, intent);
        //关闭Activity
