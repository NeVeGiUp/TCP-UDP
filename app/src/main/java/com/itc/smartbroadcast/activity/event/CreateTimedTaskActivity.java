 ...
 */
public class CreateTimedTaskActivity extends Base2Activity {
    ...
    @OnClick({R.id.bt_back_event, R.id.bt_starttime, R.id.bt_continuedtime, R.id.bt_executiondate, R.id.bt_playmode, R.id.tv_complete,
            ...
            R.id.btn_task_control, R.id.btn_clear_date, R.id.bt_priority, R.id.btn_clear_music, R.id.btn_clear_device})
    ...
    public void complete() {
        ...
        task.setTaskDuplicationPattern(1);
