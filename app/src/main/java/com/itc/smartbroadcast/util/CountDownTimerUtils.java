...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setTextColor(R.color.colorWhite);
        mTextView.setText(millisUntilFinished / 1000 + "秒");  //设置倒计时时间
        mTextView.setBackgroundResource(R.drawable.bg_offline); //设置按钮为灰色，这时是不能点击的
        ...
        ForegroundColorSpan span = new ForegroundColorSpan(R.color.colorMain);
        /**
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.loginout);  //还原背景色
    }
}
